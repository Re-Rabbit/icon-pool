...
icons.get('/export-ttf', (req, res, next) => {
...
icons.get('/export-json', (req, res, next) => {
...
icons.get('/icons/:id', (req, res, next) => {
  res.status(200).end()
})
...
icons.patch('/icons/:id', (req, res, next) => {
  res.status(200).end()
})

// delete one

icons.delete('/icons/:id', (req, res, next) => {
  res.status(200).end()
})
